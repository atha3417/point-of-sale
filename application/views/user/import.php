    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item text-info">User</li>
...
<section class="content">
  <div class="row ml-2 mt-2">
    <div class="col-md-5">
        <form action="<?= site_url('user/proccess'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
                <a href="<?= site_url('user'); ?>" class="btn btn-danger btn-icon-split">Cancel</a>
                <a href="<?= site_url('assets/file/format/user.xlsx'); ?>" target="_blank" class="btn btn-success btn-icon-split" download>Format</a>
