    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><a href="">In</a></li>
        </ol>
      </div>
    </div>
</section>
...
<a href="<?= site_url('stock/in/add'); ?>" class="btn btn-primary mb-3"><i class="fas fa-fw fa-plus"> </i>&nbsp;&nbsp; Add New Stock In</a>
	  ...
	  <tbody>
	    ...
	    <tr>
	      ...
	      <td scope="row"><a href="" class="badge badge-pill badge-secondary" id="set_dtl" 
                      ...
                      <a href="<?= base_url('stock/in/del/').$data->stock_id.'/'.$data->item_id; ?>" onclick="return confirm('Are you sure want to delete <?= $data->item_name; ?>, whoose stock in is <?= $data->qty; ?> ?');" class="badge badge-pill badge-danger">delete</a>
        </td>
	    </tr>
	 	<?php }; ?>
	  </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="ItemModalLabel"><strong>Stock In Detail</strong></h4>
