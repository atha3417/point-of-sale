<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="ml-2">Add Stock Out</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= site_url('dashboard'); ?>"><i class="fas fa-fw fa-home"></i></a></li>
              <li class="breadcrumb-item active">Transaction</li>
              <li class="breadcrumb-item active"><a href="<?= site_url('stock/out'); ?>">Stock</a></li>
              <li class="breadcrumb-item active"><a href="<?= site_url('stock/out'); ?>">Out</a></li>
    ...
    <section class="content">
      <div class="row ml-2 mt-2">
        <div class="col-md-5">
            <form action="<?= site_url('stock/proccesss'); ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="detail" placeholder="Rusak / Hilang / Kadaluwarsa / etc" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group mt-4">
                    <a href="<?= site_url('stock/out'); ?>" class="btn btn-danger btn-icon-split">
                        <span class="icon text-white-50">
                            <i class="fas fa-fw fa-arrow-left"></i>
                        </span>
                        <span class="text">Cancel</span>
                    </a>
                    <button type="submit" name="out_add" class="btn btn-primary btn-icon-split">
                      <span class="icon text-white-50">
                          <i class="fas fa-fw fa-inbox"></i>
                      </span>
                      <span class="text">Add Stock Out</span>
                    </button>
                </div>
            </form>
        </div>
