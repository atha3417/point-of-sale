<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <?php if($page == 'add') { ?>
            <h1 class="ml-2">Add Unit</h1>
            <?php } ?>
            <?php if($page == 'edit') { ?>
            <h1 class="ml-2">Update Unit</h1>
            <?php } ?>
          </div>
          <div class="col-sm-6">
        ...
        <div class="col-md-5">
            <form action="<?= site_url('unit/proccess'); ?>" method="post">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="unit_name" name="unit_name" placeholder="Unit Name" value="<?= $row->name; ?>" required>
                <div class="form-group mt-4">
                    <a href="<?= site_url('unit'); ?>" class="btn btn-danger btn-icon-split">
