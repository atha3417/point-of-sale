...
<section class="content">
  <div class="row ml-2 mt-2">
    <div class="col-md-5">
        <form action="<?= site_url('category/proccess'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group mt-4">
                <a href="<?= site_url('category'); ?>" class="btn btn-danger btn-icon-split">Cancel</a>
                <a href="<?= site_url('assets/file/format/category.xlsx'); ?>" target="_blank" class="btn btn-success btn-icon-split" download>Format</a>
