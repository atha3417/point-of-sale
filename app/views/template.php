...
<head>
  ...
  <link rel="stylesheet" rel="stylesheet" href="<?= base_url() ?>assets/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
  <link href="<?= base_url() ?>assets/dataTables/DataTables-1.10.21/css/dataTables.bootstrap4.min.css">
  <!-- Theme style -->
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?= site_url('dashboard'); ?>" class="brand-link">
        <img src="<?= base_url(); ?>assets/dist/img/favicon.png" class="brand-image img-circle elevation-3" style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <?php $city = ucfirst($this->fungsi->user_login()->city); ?>
            <a href="" class="d-block" style="font-size: 20px"><?= ucfirst($this->fungsi->user_login()->name); ?></a>
            <small style="color: #C9CBCD;"><?= ucfirst($this->fungsi->user_login()->username); ?> | <?= $city !== null ? $city : "Indonesia"; ?></small>
          </div>
        </div>
        ...
        <nav class="">
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent nav-legacy nav-compact" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <?php if ($this->fungsi->user_login()->level == 1) { ?>
              ...
              <li class="nav-item">
                <a href="<?= site_url('notification'); ?>" class="nav-link <?= $this->uri->segment(1) == 'notification' ? "active" : '' ?>">
                  <i class="nav-icon fas fa-fw fa-bell"></i>
            ...
            <li class="nav-item">
              <a class="nav-link <?= $this->uri->segment(1) == 'chat' ? 'active' : null; ?>" href="<?= base_url('chat') ?>">
    ...
    <footer class="main-footer text-center">
      Copyright &copy; 2020. <strong>Nafrozen</strong> All rights reserved.
    </footer>
